    ...
    >
      <Box className=' gap-[78px] flex flex-col container mx-auto px-8'>
        <Box className='  pt-[28px]'>
          <Text
            color={'#C7C7C7'}
            className='font-roboto text-2xl font-medium leading-6 tracking-tighter text-left'
          >
            Add Offer
          </Text>
        </Box>
        ...
        >
          <Text
            color={'#C7C7C7'}
            className='font-roboto text-lg font-medium leading-6 tracking-tighter text-left'
          >
            Upload image
          </Text>
          <Box
            backgroundColor={'#43445A'}
            className='w-[60%] h-[122px] rounded-[14px] flex justify-center items-center  '
          >
        ...
        >
          ...
          <Box
            backgroundColor={'#43445A'}
            className='w-[60%]   rounded-[14px] flex flex-col  '
          >
