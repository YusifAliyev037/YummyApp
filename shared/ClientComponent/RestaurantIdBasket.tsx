...
function RestaurantIdBasket(props: Props) {
    ...
    <div className='bg-gray200 p-4 h-[600px]'>
      ...
      <div className='hidden sm:flex flex-col justify-between h-full'>
        ...
        <div className='flex rounded-full mt-auto items-center justify-between p-2 bg-white50'>
          ...
          <button className='bg-white text-white50 font-medium py-1 px-10 rounded-full shadow-md hover:scale-95 transition-all duration-500'>
            {data?.total_amount}$
          </button>
        </div>
      </div>
